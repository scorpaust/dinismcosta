...
export const CartProvider = ({ children }) => {
    ...
    const removeItemFromCart = (service) => {
        setCartItems(removeCartItem(cartItems, service));
    }

    const clearItemFromCart = (service) => {
        setCartItems(clearCartItem(cartItems, service));
    }

    const value = { isCartOpen, setIsCartOpen, cartItems, addItemToCart, removeItemFromCart, clearItemFromCart, cartCount, cartTotal, setCartCount };
